...
@Component({
  selector: 'app-background-slider-example',
  templateUrl: './background-slider-example.component.html',
  styleUrls: ['./background-slider-example.component.scss'],
})
export class BackgroundSliderExampleComponent implements OnInit {
  images = [
